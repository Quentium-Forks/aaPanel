...
class main(dockerBase):
    ...
    def backup_volume(self, get):
        ...
        try:
            ...
            if not volume_list:
                return public.returnMsg(False, "There is no volume to back up")
            ...
            return public.returnMsg(True, "The backup task was created successfully. Please wait for the directory backup to complete. It may take more than 1 minute！")
        except Exception as e:
            print(traceback.format_exc())
            return public.returnMsg(False, "Failed to create a backup task{}".format(str(e)))
    ...
    def remove_backup(self, get):
        ...
        try:
            ...
            print(traceback.format_exc())
            return public.returnMsg(False, "{} Failed to delete the file, reason: {}".format(get.name, str(e)))
