    ...
    var SafeConfig = (function (_super) {
        ...
        function SafeConfig() {
            ...
            _this.apiInfo = {
                ...
                'getTempAuthList': ['config/get_temp_login', 'Get temporary authorization list, please wait...'],
        ...
        SafeConfig.prototype.init = function (data) {
            ...
            var password_safe = pawComplexity.password_safe, expire = pawComplexity.expire,
        ...
        SafeConfig.prototype.event = function () {
            ...
            $('.panelSslConfig').on('click', function () {
                return _this.setPanelSslConfigView();
            });
            $('input[name="basic_auth"]').change(function (e) {
                ...
                if (checked) {
                    ...
                    var title = '关闭BasicAuth认证';
                    var msg = '关闭BasicAuth认证后，面板登录将不再验证BasicAuth基础认证，这将会导致面板安全性下降，继续操作！';
                    var api = 'setBasicAuth';
                    _this.showCheckboxConfirm({
                        e: e,
                        api: api,
                        config: {title: title, msg: msg}, data: {open: 'False', basic_user: '', basic_pwd: ''}
                    }).then(function (res) {
            ...
            $('input[name="check_two_step"]').change(function (e) {
                ...
                if (checked) {
                    ...
                    _this.showCheckboxConfirm({
                        e: e,
                        api: api,
                        config: {title: title, msg: msg}, data: {act: false}
                    }).catch(function (err) {
                    });
                }
            });
            $('.checkTwoStepConfig').click(function () {
                return _this.googleAuthRelationView();
            });
            $('input[name="paw_complexity"]').change(function (e) {
                ...
                var msg = checked ? lan.config.strong_password_desc1+'<span style="color:red;">'+lan.config.strong_password_desc2+'</span>' : lan.config.strong_password_desc3;
            ...
            $('.setSafetyEntrance').click(function () {
                return _this.setSafetyEntranceView();
            });
            $('.setStatusCodeView').click(function () {
                return _this.setStatusCodeView();
            });
            $('.setPawExpiration').click(function () {
                return _this.setPawExpirationView();
            });
                            ...
                            return [4, this.$open({
                                ...
                                content: {
                                    ...
                                    template: function () {
                                        var lineWidth = '80px', inputWidth = '280px',
                                            helpHref = 'https://forum.aapanel.com/d/167-common-problems-after-opening-the-panel-certificate';
                                        return (0, snabbdom_1.jsx)("div", {
                                                class: this.$class('bt-form'),
                                                style: this.$style('padding: 20px 50px;')
                                            },
                                            ...
                                            (0, snabbdom_1.jsx)("div", {class: {pt10: true}},
                                                ...
                                                this.$line({
                                                    title: 'Key',
                                                    width: lineWidth,
                                                    hide: parseInt(this.cert_type) !== 3
                                                }, this.$textarea({
                                                    model: 'privateKey',
                                                    width: inputWidth,
                                                    height: '100px',
                                                ...
                                                this.$learnMore({
                                                    ...
                                                    link: this.$link({
                                                        title: lan.config.ssl_open_ps_5,
                                                        href: 'https://forum.aapanel.com/d/167-common-problems-after-opening-the-panel-certificate'
                                                    })
                                                })));
                                    }
                                },
                                ...
                                yes: function (config) {
                                    return __awaiter(_this, void 0, void 0, function () {
                                        var close, vm, cert_type, mail, privateKey, certPem, agreement, _a, rdata;
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    close = config.close, vm = config.vm;
                                                    cert_type = vm.cert_type, mail = vm.mail, privateKey = vm.privateKey, certPem = vm.certPem, agreement = vm.agreement;
                                                    if (!agreement)
                                                        return [2, this.$tips({
                                                            el: '#agreement_more',
                                                    ...
                                                    return [4, this.$verifySubmitList([
                                                        ...
                                                        [cert_type === '2' && !mail, 'Please enter administrator email']
                                                    ])];
                                                case 1:
                                                    _b.sent();
                                                    _a = cert_type === '3';
                                                ...
                                                case 3:
                                                    _a;
                                                    return [4, this.$request('setPanelSsl', Object.assign({cert_type: cert_type}, vm.cert_type === '2' ? {email: mail} : {}))];
                                                case 4:
																									rdata = _b.sent();
																									if (rdata.status) {
                                                    ...
                                                    switch (_b.label) {
                                                        case 0:
                                                            ...
                                                            return [4, that_1.$verifySubmitList([
                                                                [!certPem || !privateKey, 'Please enter certificate information'],
                                                            ])];
                                                        case 1:
                                                            _b.sent();
                                                            return [4, that_1.$request('savePanelSsl', {
                                                                privateKey: privateKey,
                                                                certPem: certPem
                                                            })];
                                                        case 2:
                    ...
                    template: function () {
                        return (0, snabbdom_1.jsx)("div", {class: this.$class('bt-form pd25')},
                            ...
                            this.$learnMore({
                                ...
                                id: 'checkBasicAuth',
                                // link: this.$link({
                                //     title: 'What is BasicAuth authentication?',
                        ...
                        content: {
                            ...
                            template: function () {
                                ...
                                return (0, snabbdom_1.jsx)("div", {class: this.$class('bt-form pd25')},
                                    ...
                                    this.$line({title: lan.public.username}, this.$input({
                                        model: 'basic_user',
                                        placeholder: lan.config.set_username,
                                        width: inputWidth
                                    })),
                                    this.$line({title: lan.public.pass}, this.$input({
                                        model: 'basic_pwd',
                                        placeholder: lan.config.set_passwd,
                                        width: inputWidth
                                    })),
                                    this.$line({title: ''}, this.$button({
                                        title: lan.public.save,
                                        click: this.saveBasicAuth.bind(this)
                                    })),
                                    this.$ul([
                                        [lan.config.basic_auth_tips1, 'red'],
                                        [lan.config.basic_auth_tips2],
                                        [lan.config.basic_auth_tips3],
                                    ]));
                            },
                            methods: {
                    ...
                    this.$open({
                        ...
                        content: {
                            ...
                            template: function () {
                                return (0, snabbdom_1.jsx)("div", {
                                        class: this.$class('bt-form'),
                                        style: this.$style('padding:20px 35px;')
                                    },
                            ...
                            mounted: function () {
                                return __awaiter(this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        ...
                                        Promise.all([
                                            that.$request('getTwoStepKey', false),
                                            that.$request('getQrcodeData', {act: 1}, false),
                                            that.$require('jquery.qrcode')
        ...
        SafeConfig.prototype.setSafetyEntranceView = function () {
            ...
            this.$open({
                ...
                content: {
                    ...
                    template: function () {
                        return (0, snabbdom_1.jsx)("div", {class: this.$class('pd20 bt-form')}, this.$line({title: lan.config.entry_addr}, this.$input({
                            model: 'expire',
                            width: '240px'
                        })));
                    }
        ...
        SafeConfig.prototype.setPawExpirationView = function () {
            ...
            this.$open({
                ...
                content: {
                    ...
                    template: function () {
                        return (0, snabbdom_1.jsx)("div", {class: this.$class('pd20 bt-form')},
                            this.$line({title: lan.config.expire_time}, this.$box(this.$input({
                                model: 'expire',
                                placeholder: '',
                                width: '120px'
                            }), (0, snabbdom_1.jsx)("span", null, "Days"))),
                            this.$ul([
                                [lan.config.expire_password_desc1, 'red'],
                                [lan.config.expire_password_desc2]
                            ]));
                    }
                },
                yes: function (config) {
                                                    ...
                                                    switch (_a.label) {
                                                        ...
                                                        case 2:
                                                            ...
                                                            clipboards.on('error', function (ev) {
                                                                _this.$msg({
                                                                    status: false,
                                                                    msg: 'Copy failed, please copy address manually'
                                                                });
                                                            });
                                                            return [2];
                                                    }
