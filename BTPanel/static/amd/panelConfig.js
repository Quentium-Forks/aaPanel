...
define(["require", "exports", "./snabbdom", "./configMixin"], function (require, exports, snabbdom_1, configMixin_1) {
    ...
    var PanelConfig = (function (_super) {
        ...
        PanelConfig.prototype.init = function (data) {
            ...
            var ipv6 = configInfo.ipv6, is_local = configInfo.is_local, debug = configInfo.debug, api = configInfo.api,
                session_timeout = configInfo.session_timeout, sites_path = configInfo.sites_path,
                backup_path = configInfo.backup_path, panel = configInfo.panel, systemdate = configInfo.systemdate;
                ...
                content: {
                    ...
                    template: function () {
                        return (0, snabbdom_1.jsx)("div", {class: this.$class('bt-form pd25')},
                            ...
                            this.$learnMore({
                                title: 'I understand and am willing to take the risk, confirm to open',
                                model: 'agreement',
                                id: 'checkDevelopers'
                            }));
                    }
                        ...
                        case 2:
                            ...
                            return [4, this.$open({
                                ...
                                content: {
                                    ...
                                    template: function () {
                                        var lineWidth = '125px',
                                            helpHref = 'https://forum.aapanel.com/d/482-api-interface-tutorial';
                                        return (0, snabbdom_1.jsx)("div", {
                                                class: this.$class('bt-form'),
                                                style: this.$style('padding: 15px 25px;')
                                            },
                                            this.$line({
                                                title: lan.config.api,
                                                width: lineWidth
                                            }, this.$switch({model: 'api', change: this.setPanelApi.bind(this)})),
                                            this.$line({
                                                title: lan.config.int_sk,
                                                width: lineWidth
                                            }, this.$box(this.$input({
                                                ...
                                                return __generator(this, function (_a) {
                                                    that.$confirm({
                                                        ...
                                                        if (res.status) {
                                                            ...
                                                            that.$msg({
                                                                msg: lan.config.create_int_key_success,
                                                                time: 0,
                                                                closeBtn: 2
                                                            });
                                                        } else {
                                        ...
                                        savePanelApiIp: function () {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            return [4, that.$request('setToken', {
                                                                t_type: 3,
