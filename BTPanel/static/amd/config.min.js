...
define(["require", "exports", "./snabbdom", "./public/public", "./panelConfig"], function (require, exports, snabbdom_1, public_1, panelConfig_1) {
    "use strict";
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    Promise.all([
                        ...
                        var configInfo = resArr[0], twoStep = resArr[1], pawComplexity = resArr[2], bindUserInfo = resArr[3], messageChannelInfo = resArr[4], loginAlarmInfo = resArr[5];
                        panelConfig.init({ configInfo: configInfo });
                    }).catch(function (err) {
