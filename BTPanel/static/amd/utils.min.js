...
define("public/vdom", ["require", "exports", "snabbdom"], function (require, exports, snabbdom_1) {
    ...
    var Vm = (function () {
        ...
        Vm.prototype.$warningTitle = function (tips) {
            return (0, snabbdom_1.jsx)("div", { class: { 'mb15': true, 'layer-info-head': true } },
        ...
        Vm.prototype.$learnMore = function (config) {
            var title = config.title, model = config.model, className = config.className, style = config.style, id = config.id, link = config.link, relation = model + '_more';
            return (0, snabbdom_1.jsx)("div", { class: this.$class("mt10 agreementBox ".concat(className || '')), props: { id: id }, style: this.$style(style) },
                (0, snabbdom_1.jsx)("div", { class: this.$class('agreementCont') },
    ...
    var Utils = (function () {
        ...
        Utils.prototype.$send = function (param, param1, param2) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (loading)
                    loadT = _this_1.$load("".concat(loading));
                $.ajax({
                    url: config.url,
...
define("public/public", ["require", "exports", "snabbdom", "public/utils"], function (require, exports, snabbdom_2, utils_1) {
    ...
    var Public = (function (_super) {
        ...
        Public.prototype.fixedTableHead = function (el, height, isBorder) {
            if (isBorder === void 0) { isBorder = true; }
            $(el).css({ 'border': 'none' });
                    ...
                    template: function () {
                        return (0, snabbdom_2.jsx)("div", { class: this.$class('pd20 bt-form libLogin') },
                            ...
                            (0, snabbdom_2.jsx)("p", { class: { 'text-right': true } },
                                " ",
                                this.$link({ title: lan.public_backup.no_account, href: 'https://brandnew.aapanel.com/user_admin/login' })));
                    },
                    methods: {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            for (i_1 = 0; i_1 < diskList.length; i_1++) {
                                item = diskList[i_1];
                                diskHtml += "<dd class=\"bt_open_dir size_ellipsis\" title='" + item.path + "' path =\"" + item.path + "\"><span class='glyphicon glyphicon-hdd'></span><span class=\"text\">" + item.path + "</span></dd>";
                            }
                        ...
                        case 1:
                            ...
                            return [4, this.$open({
                                    ...
                                    success: function () {
                                        ...
                                        $('.setMailMessageView').on('click', function () { return _this_1.setMailMessageView(info); });
                                        ...
                                        $(".addTelegram").click(function () { return __awaiter(_this_1, void 0, void 0, function () {
                                        ...
                                        $('.delTelegram').click(function () { return __awaiter(_this_1, void 0, void 0, function () {
                                            var res, err_3;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
        ...
        Public.prototype.setMailMessageView = function (info) {
            return __awaiter(this, void 0, void 0, function () {
                var rdata, _a, qq_mail, qq_stmp_pwd, hosts, port, verifyPortList, err_4;
                var _this_1 = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [4, this.$open({
                                    ...
                                    success: function (layers, indexs) { return __awaiter(_this_1, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            ...
                                            $('.set_empty').click(function () { return __awaiter(_this_1, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4, this.$request(['config/set_empty', 'notification, please wait...'], { type: 'mail' })];
                                                        case 1:
                                                            rdata = _a.sent();
                                                            if (!rdata.status)
                                                                return [2];
