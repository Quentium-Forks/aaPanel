		...
		bt_tools.table({
			...
			column: [
				...
				{ title: lan.security.firewall.ports, fid: 'ports', width: 200 },
				{
					field: 'status',
					title:
						lan.security.firewall.status + '<a href="https://www.bt.cn/bbs/thread-4708-1-1.html" class="bt-ico-ask" target="_blank" title="' + lan.security.firewall.port.th3_click + '">?</a>',
					width: 150,
					type: 'text',
